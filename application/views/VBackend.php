  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?php echo site_url('Welcome/DataProfile'); ?>"><i class="fa fa-book"></i> <span>Profile</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataKontak'); ?>"><i class="fa fa-book"></i> <span>Kontak</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataBerita'); ?>"><i class="fa fa-book"></i> <span>Berita</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataGuru'); ?>"><i class="fa fa-book"></i> <span>Guru</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataMapel'); ?>"><i class="fa fa-book"></i> <span>Mapel</span></a></li>
        <li><a href="<?php echo site_url('Welcome/DataJadwal'); ?>"><i class="fa fa-book"></i> <span>Jadwl</span></a></li>
